...
export function trouverActeSuture(localisation, profondeur, taille) {
    const acte = actesSutures.find(a => a.localisation === localisation && a.profondeur === profondeur && a.taille === taille);
    return acte?.acte;
}
